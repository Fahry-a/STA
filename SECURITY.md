...
#### 2. Send details to: [GitHub Security Advisories](https://github.com/Fahry-a/STA/security/advisories/new)
...
- **Contact**: [GitHub Security Advisories](https://github.com/Fahry-a/STA/security/advisories/new)
